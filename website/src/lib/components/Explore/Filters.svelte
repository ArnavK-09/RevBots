<div class="w-full px-5">
	...
	>
		...
		<div>
			<div>
				<span class="text-xs tracking-wider font-thick text-gray-400/70"> Sort By: </span>
				<select
					class="text-sm text-center px-3 py-px font-medium rounded border-2 border-red-700 text-white/80 bg-red-700/10 appearance-none"
				>
